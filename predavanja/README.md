# Рачунарска интелигенција - предавања
...
- **Уводна разматрања**
  ...
  - **[Анализа, одлучивање, оптимизација (енг.)](prezentacije/01-uvod/01-introduction-bic.pdf){:target="_blank"}**
...
- **Дефиниција и опис оптимизације**
  ...
  - **[Оптимизација](prezentacije/02-optimizacija/01-optimizacija-uvod.pdf){:target="_blank"}**

  - **[Рекaпитулација појмова који се односе на графове (енг.)](prezentacije/02-optimizacija/02-grafovi-uvod-eng.pdf){:target="_blank"}**

  - **[Оптимизација (енг.)](prezentacije/02-optimizacija/03-optimizacija-uvod-1-bic.pdf){:target="_blank"}**

  - **[Оптимизација 2 (енг.)](prezentacije/02-optimizacija/04-optimizacija-uvod-2-bic.pdf){:target="_blank"}**

- **Линеарно програмирање**

  - **[Математичко програмирање (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/00-matematicko-programiranje-gur.pdf){:target="_blank"}**

  - **[Линаеарно програмирање (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-linearno-programiranje-gur.pdf){:target="_blank"}**

  - **Примери проблема линераног програмирања**

    - [Проблем производње (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-linearno-programiranje-gur.pdf){:target="_blank"}

    - [Проблем инвестирања (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-pr2-linearno-programiranje-investirranje-bic.pdf){:target="_blank"}

    - [Проблем транспорта (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-pr3-linearno-programiranje-transport-bic.pdf){:target="_blank"}

    - [Проблем креирање смесе (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-pr4-linearno-programiranje-mesanje-bic.pdf){:target="_blank"}
  
    - [Проблем стања на складишту (енг.)](prezentacije/03-linearno-i-celobrojno-programiranje/03-01-linearno-programiranje/01-pr5-linearno-programiranje-skladiste-bic.pdf){:target="_blank"}
...
- **Нелинеарна оптимизација**
  ...
  - **Нелинеарна оптимизација функције једне променљиве**
    ...
    - **[Опис проблема (енг.)](prezentacije/04-nelinearna-optimizacija/04-01-univarijabilna-nelinearna-optimizacija/01-nelinearna-optimizacija-uvod-eng.pdf){:target="_blank"}**

    - **[Метода сечице (енг.)](<prezentacije/04-nelinearna-optimizacija/04-01-univarijabilna-nelinearna-optimizacija/02-nelinearna-optimizacija-secica-eng .pdf>){:target="_blank"}**

    - **[Њутнова метода (енг.)](prezentacije/04-nelinearna-optimizacija/04-01-univarijabilna-nelinearna-optimizacija/03-nelinearna-optimizacija-njutn-eng.pdf){:target="_blank"}**

  - **Нелинеарна оптимизација функције више променљивих**
  
    - **[Опис проблема (енг.)](prezentacije/04-nelinearna-optimizacija/04-02-multivarijabilna-nelinearna-optimizacija/01-nelinearna-optimizacija-uvod-eng.pdf){:target="_blank"}**

    - **[Метода најстрмијег спуста (енг.)](<prezentacije/04-nelinearna-optimizacija/04-02-multivarijabilna-nelinearna-optimizacija/02-nelinearna-optimizacija-najstrmiji-spust-eng .pdf>){:target="_blank"}**

    - **[Њутнова метода (енг.)](prezentacije/04-nelinearna-optimizacija/04-02-multivarijabilna-nelinearna-optimizacija/03-nelinearna-optimizacija-njutn-eng.pdf){:target="_blank"}**

- **Метахеуристике**

  - **[Опис метахеуристика (енг.)](prezentacije/05-metaheuristike/01-metaheuristike-eng.pdf){:target="_blank"}**

  - **[Еволутивна израчунавања](prezentacije/05-metaheuristike/02-evolutivna-izracunavanja.pdf){:target="_blank"}**
  ...
  - **[Интелигенција група](prezentacije/05-metaheuristike/05-inteligencija-grupa.pdf){:target="_blank"}**
