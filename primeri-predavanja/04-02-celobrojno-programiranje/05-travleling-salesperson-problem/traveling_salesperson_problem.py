...
# • the TSP (Travelling Salesman Problem) problem, which has been first formulated in 1930 and is one of the most intensively studied problems in optimization,
...
# The Travelling Salesman Problem (TSP) asks the following question: Given a list of cities and the distances between each pair of cities, what is the shortest possible route that visits each
...
# For example the metric-TSP requires that the triangle inequality holds for all triples of edges (as for the euclean distance).
